...
A stylized water shader supporting **Gerstner waves**, foam generation, Caustics and surface distortion.

### Screenshot

![Stylized Water Shader](screenshots/StylizedWater.gif)

# ✨ Toon Style Transparent Water

A toon style water shader supporting Caustics, foam generation, and surface distortion.

### Screenshot

![Toon Water Shader](screenshots/ToonWater.gif)
